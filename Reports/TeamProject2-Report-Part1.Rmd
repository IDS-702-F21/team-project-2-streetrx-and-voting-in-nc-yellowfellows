...
$$ {\rm ppm}_i = (\beta_{0} + \gamma_{0j} + \psi_{0j}) + \beta_1\cdot{\rm mgstr}_{ij} + \beta_2\cdot{\rm bulk\_purchase}_{ij}+\beta_3\cdot{\rm source}_{ij} + \varepsilon_{ij} \\$$
$$ \varepsilon_{ij} \sim \mathcal{N}(0, \sigma^2), i=1, ..., n; j=1,...,J $$
$$ \gamma_{ij} \sim \mathcal{N}(0, \tau_{0}^2), i=1, ..., n; j=1,...,J $$
$$ \psi_{ij} \sim \mathcal{N}(0, \varsigma_{0}^2), i=1, ..., n; j=1,...,J $$
