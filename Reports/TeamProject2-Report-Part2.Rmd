...
According to our model, different ethnic and race groups have significantly different turnout rates. Black citizens are 17% less likely to vote in comparison to Asians. Non-Hispanic turnout rates also tend to be 42% higher in comparison to Hispanic voters. On the other hand, the model suggested no significant difference in how votes differ by gender unless we also consider the party affiliation. For example, males of the Green party or people of undesignated gender of the Libertarian Party both tend to have higher turnout rates than females of the Constitutional party, which is the baseline. [TODO: age by itself, and maybe move gender:party to the paragraph below]
