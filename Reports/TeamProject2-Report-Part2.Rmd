...
According to our model, different demographic subgroups, such as ethnic and race groups, have significantly different turnout rates. For instance, Black citizens are 17% less likely to vote in comparison to Asians. Non-Hispanic turnout rates also tend to be 42% higher in comparison to Hispanic voters. On the other hand, the model suggested no significant difference in how votes differ by gender unless we also consider the party affiliation. If we do look at how sex and party affiliation interact we can observe a significant effect. For example, males of the Green party or people of undesignated gender of the Libertarian Party both tend to have higher turnout rates than females of the Constitutional party, which is the baseline.
Moreover, the model showed that differences in turnout rate by age group for different party affiliations is also significant. For the Green party, young citizens (18-25 years old) have a higher turnout than their peers in other parties, though overall, older people are generally more likely to vote.


*TODO: finish review*

""" Queston 2"""
We used a hierarchical model to analyze the turnout rates between the different counties in North Carolina. Among the 25 sampled counties, Anson, Cherokee, and Robeson have the lowest turnouts, and Carteret, Alexander, and Orange have the highest turnouts. This is also an indication that the odds of voting could indeed differ by counties. The difference in turnout rates could be explained by other per-county characteristics, which is a topic worth examining in future research. 
